...
const $anyscalar = $.makeType(_.spec, "ed7cd35a-82c4-11ec-b587-c739fea22cb0", _.syntax.literal);
const $anyreal = $.makeType(_.spec, "ed833dda-82c4-11ec-997c-49275c375371", _.syntax.literal);
const $anyfloat = $.makeType(_.spec, "ed872f80-82c4-11ec-b782-1b28f9aecc32", _.syntax.literal);
const $anyint = $.makeType(_.spec, "ed841cdc-82c4-11ec-b2f9-154c86e39cdc", _.syntax.literal);
const $anynumeric = $.makeType(_.spec, "ed8976aa-82c4-11ec-9f7e-fdb3dc561296", _.syntax.literal);
...
const $sequence = $.makeType(_.spec, "ed8bcf18-82c4-11ec-bbd0-55d0df4ceed9", _.syntax.literal);
...
const $BaseObject = $.makeType(_.spec, "f52a7602-82c4-11ec-8e7b-6daf7a5b1023", _.syntax.literal);
const BaseObject = _.syntax.$PathNode($.$toSet($BaseObject, $.Cardinality.Many), null, true);
const $Object_f5328eb482c411ecbcd651fdcf80cd29 = $.makeType(_.spec, "f5328eb4-82c4-11ec-bcd6-51fdcf80cd29", _.syntax.literal);
const Object_f5328eb482c411ecbcd651fdcf80cd29 = _.syntax.$PathNode($.$toSet($Object_f5328eb482c411ecbcd651fdcf80cd29, $.Cardinality.Many), null, true);
const $FreeObject = $.makeType(_.spec, "f53aa43c-82c4-11ec-982b-4d95adbee1ae", _.syntax.literal);
...
function min(...args) {
    const { returnType, cardinality, args: positionalArgs, namedArgs } = _.syntax.$resolveOverload('std::min', args, _.spec, [
        { args: [{ typeId: "ed833dda-82c4-11ec-997c-49275c375371", optional: false, setoftype: true, variadic: false }], returnTypeId: "ed833dda-82c4-11ec-997c-49275c375371", returnTypemod: "OptionalType", preservesOptionality: true },
        { args: [{ typeId: "ed8c9ce0-82c4-11ec-ba8c-614d1802d51a", optional: false, setoftype: true, variadic: false }], returnTypeId: "ed8c9ce0-82c4-11ec-ba8c-614d1802d51a", returnTypemod: "OptionalType", preservesOptionality: true },
...
function sequence_reset(...args) {
    const { returnType, cardinality, args: positionalArgs, namedArgs } = _.syntax.$resolveOverload('std::sequence_reset', args, _.spec, [
        { args: [{ typeId: "f9590072-82c4-11ec-9c44-6fef14735ff0", optional: false, setoftype: false, variadic: false }], returnTypeId: "00000000-0000-0000-0000-0000000001ff" },
        { args: [{ typeId: "f9590072-82c4-11ec-9c44-6fef14735ff0", optional: false, setoftype: false, variadic: false }, { typeId: "00000000-0000-0000-0000-0000000001ff", optional: false, setoftype: false, variadic: false }], returnTypeId: "00000000-0000-0000-0000-0000000001ff" },
    ]);
    return _.syntax.$expressionify({
        __kind__: $.ExpressionKind.Function,
        __element__: returnType,
...
;
Object.assign(exports, { $anyscalar: $anyscalar, $anyreal: $anyreal, $anyfloat: $anyfloat, $anyint: $anyint, $anynumeric: $anynumeric, bigint: bigint, bool: bool, bytes: bytes, datetime: datetime, decimal: decimal, duration: duration, float32: float32, float64: float64, int16: int16, int32: int32, int64: int64, json: json, $sequence: $sequence, str: str, uuid: uuid, number: number, $BaseObject: $BaseObject, BaseObject: BaseObject, $Object_f5328eb482c411ecbcd651fdcf80cd29: $Object_f5328eb482c411ecbcd651fdcf80cd29, Object_f5328eb482c411ecbcd651fdcf80cd29: Object_f5328eb482c411ecbcd651fdcf80cd29, $FreeObject: $FreeObject, FreeObject: FreeObject });
const __defaultExports = {
    ...
    "Object": Object_f5328eb482c411ecbcd651fdcf80cd29,
