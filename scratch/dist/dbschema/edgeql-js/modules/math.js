...
function var_fc6d953482c411eca5f87bdbe062e2af(...args) {
...
function abs(...args) {
    const { returnType, cardinality, args: positionalArgs, namedArgs } = _.syntax.$resolveOverload('math::abs', args, _.spec, [
        { args: [{ typeId: "ed833dda-82c4-11ec-997c-49275c375371", optional: false, setoftype: false, variadic: false }], returnTypeId: "ed833dda-82c4-11ec-997c-49275c375371" },
    ]);
    return _.syntax.$expressionify({
        __kind__: $.ExpressionKind.Function,
        __element__: returnType,
...
const __defaultExports = {
    "var": var_fc6d953482c411eca5f87bdbe062e2af,
    "abs": abs,
    "ceil": ceil,
    "floor": floor,
    "ln": ln,
