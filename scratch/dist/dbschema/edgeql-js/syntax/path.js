...
function _$pathify(_root) {
    ...
    const root = _root;
    let pointers = Object.assign({}, root.__element__.__pointers__);
    if (root.__parent__) {
        ...
        if ((parentPointer === null || parentPointer === void 0 ? void 0 : parentPointer.__kind__) === "link") {
            pointers = Object.assign(Object.assign({}, pointers), parentPointer.properties);
        }
    }
...
function isFunc(expr) {
    return $expressionify({
        ...
        __element__: Object.assign(Object.assign({}, expr.__element__), { __shape__: { id: true } }),
        __expr__: this,
    });
}
...
function $getScopedExpr(expr, existingScopes) {
    ...
    if (!scopedExpr || (existingScopes === null || existingScopes === void 0 ? void 0 : existingScopes.has(scopedExpr))) {
        ...
        scopedExpr = $expressionify(Object.assign(Object.assign({}, expr), { __cardinality__: reflection_1.Cardinality.One, __scopedFrom__: expr }));
