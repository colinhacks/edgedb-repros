...
function renderEdgeQL(_expr, ctx, renderShape = true, noImplicitDetached = false) {
    ...
    function renderWithBlockExpr(varExpr, _noImplicitDetached) {
        ...
        let renderedExpr = renderEdgeQL((_a = withBlockElement.scopedExpr) !== null && _a !== void 0 ? _a : varExpr, Object.assign(Object.assign({}, ctx), { renderWithVar: varExpr }), !withBlockElement.scopedExpr, _noImplicitDetached);
    ...
    if (expr.__kind__ === reflection_1.ExpressionKind.With) {
        ...
        if ((0, reflection_1.isObjectType)(expr.__element__)) {
            ...
            if (needsScalarVar) {
                ctx = Object.assign(Object.assign({}, ctx), { withVars: new Map(ctx.withVars) });
...
UNION (\n${indent(renderEdgeQL(expr.__expr__, ctx), 2)}\n))`;
        ...
        return `(DETACHED ${renderEdgeQL(expr.__expr__, Object.assign(Object.assign({}, ctx), { renderWithVar: expr.__expr__ }), undefined, true)})`;
    }
    else {
